...
python3 "/home/gridsan/qwang/urban-control/src/train_controlnet.py" \
  --pretrained_model_name_or_path "models/stable-diffusion-v1-5" \
  --output_dir "output/20250416_v2" \
  --tracker_project_name "20250416_v2" \
  --seed 42 \
  --num_train_epochs 10 \
  ...
  --train_data_dir "./data/train/20250416_v2_train.csv" \
  ...
  --validation_prompt \
    ...
    "This is a satellite image of la where the city forms the core. Additionally, the landscape is primarily industrial (40%) , with pockets of residential (35%), commercial (5%) . This area has a high building density. Additionally, the residential buildings are mainly apartment complexes. Meanwhile, the residential area is concentrated in the center of the image in shaded orange." \
